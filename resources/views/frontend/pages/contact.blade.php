...
@section('main-content')
	...
	<div class="map-section">
		<div id="myMap">
			<h2>Find Us</h2>
			<img src="https://api.mapbox.com/styles/v1/mapbox/streets-v11/static/pin-s-marker+ff0000(4.354673,50.841492)/4.356554,50.839952,15/1024x500@2x?access_token=pk.eyJ1IjoibW9maXgiLCJhIjoiY2x6NjVrMDB5M3k5bjJtcXI4dmd1MHoyZSJ9._A-8VGq2yvNdzoll2CBgbw" alt="Map">
		</div>
	</div>
	<!--/ End Map Section -->
