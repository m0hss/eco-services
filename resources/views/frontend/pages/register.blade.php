...
@section('title','ECO-Services || Register Page')
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="label-n-radios">
                                            <label>You are :</label>
                                            <div class="radio-group">
                                                <div class="radio-btn">
                                                    <input type="radio" id="Individual" name="user_type" value="Individual" {{ old('user_type') == 'Individual' ? 'checked' : '' }}>
                                                    <label for="Individual">Individual</label>
                                                </div>
                                                <div class="radio-btn">
                                                    <input type="radio" id="professional" name="user_type" value="professional" {{ old('user_type') == 'professional' ? 'checked' : '' }}>
