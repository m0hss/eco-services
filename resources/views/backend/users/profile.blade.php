                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body mt-4 ml-2">
                            ...
                            <p class="card-text text-left"><small class="text-muted"><i class="fas fa-bookmark"></i>
                                    {{ ucfirst($profile->role) }}</small></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-8">
                    <form class="border px-4 pt-2 pb-3" method="POST" action="{{ route('profile-update', $profile->id) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select name="role" class="form-control">
                                ...
                                <option value="user_pro" {{ $profile->role == 'user_pro' ? 'selected' : '' }}>User Pro
                                </option>
                            </select>
                            @error('role')
                                <span class="text-danger">{{ $message }}</span>
